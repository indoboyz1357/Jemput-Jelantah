  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Tagihan Saya</h2>
          <p className="text-gray-600">Kelola pembayaran pickup Anda</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-red-50 rounded-xl p-6 border border-red-100">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-semibold text-red-800">Belum Dibayar</h3>
          </div>
        ...
        <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-semibold text-blue-800">Total Tagihan</h3>
          </div>
